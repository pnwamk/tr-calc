...
Lemma disjsyl_3rand_l : forall P Q o t t',
in_prop (o ::~ t') (P && Q && (o ::= (tU t t'))) = true
-> Proves (P && Q && (o ::= (tU t t'))) (o ::= t).
Proof.
  intros.
  eapply in_prop_Proves in H.
...
Lemma disjsyl_3rand_r : forall P Q o t t',
in_prop (o ::~ t) (P && Q && (o ::= (tU t t'))) = true
-> Proves (P && Q && (o ::= (tU t t'))) (o ::= t').
Proof.
  intros.
