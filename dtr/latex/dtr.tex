...
\and
  ...
  {\TypeOf{\Gamma}{(vec \: e_1 \: \dots \: e_n)}{\deptype{x}{\vectype{\tau}}{n = \lenpe(x)}}{\Tprop}{\NullO}}

\and
  \inferrule[T-Ref]
  {\TypeOf{\Gamma}{e_1}{\vectype{\tau}}{\psi_1}{o_1} \\\\
    \TypeOf{\Gamma}{e_2}{\deptype{x}{\Ntype}{0 \leq x < \lenpe(o_1)}}{\psi_2}{o_2}}
...
\and
  \inferrule[L-Dep]
  {\Proves{\Gamma}{\tau_{\pi(x)}} \\ \Proves{\Gamma}{\psi}}
  {\Proves{\Gamma}{\deptype{y}{\tau}{\psi}_{\pi(x)}}}

\and
  \inferrule[L-DepWeak]
  {\Proves{\Gamma}{\deptype{y}{\tau}{\psi}_{\pi(x)}}}
  {\Proves{\Gamma}{\psi[\pi(x) / y]}}
